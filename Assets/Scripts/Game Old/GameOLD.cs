...
//        {
//            foreach (Transform mino in tetrominoOLD.transform)
//            {
...
//            }
//        }
//        FindObjectOfType<GameManagerOLD>().NumberOfRowsThisTurn++;
//        return true;
//    }
...
//        else
//        {
//            priviewTetromino.transform.localPosition = new Vector2(4.0f, 20.0f);
...
//    {
//        PlayerPrefs.SetInt("lastScore", FindObjectOfType<GameManagerOLD>().currentScore);
